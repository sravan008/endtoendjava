...
public class LongestPalindromSubString {
    ...
    static int expandFormMiddle(String s, int left, int right){
    ...
    public static void main(String[] args) {
        ...
        //System.out.println(findLongestPalindrome("abaccab"));
        System.out.println(findLongestPalindrome("abaxyzzyxb"));
